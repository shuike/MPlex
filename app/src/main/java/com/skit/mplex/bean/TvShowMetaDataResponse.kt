...
@Keep
data class TvShowMetaDataResponse(
    ...
    data class MediaContainer(
        ...
        val augmentationKey: String, // /library/metadata/augmentations/76
        ...
        data class Metadata(
            ...
            val duration: Long, // 3240000
            @SerializedName("Extras")
            val extras: Extras,
            @SerializedName("Genre")
            val genre: List<Genre>,
            @SerializedName("guid")
            val guid: String, // plex://show/5ecc3ba48e44b0004171c15e
            @SerializedName("Guid")
            val guids: List<Guid>,
            ...
            val primaryExtraKey: String, // /library/metadata/1322
            @SerializedName("Rating")
            val rating: List<Rating>,
            @SerializedName("ratingKey")
            val ratingKey: String, // 1312
            @SerializedName("Role")
            val role: List<Role>,
            @SerializedName("studio")
            val studio: String, // Team Downey
            @SerializedName("summary")
            val summary: String, // 为了寻找家人和家园，半人半鹿的可爱男孩与他暴躁的守护者踏上了后末日世界的传奇冒险之旅。
            @SerializedName("tagline")
            val tagline: String, // The end of our world is the beginning of his
            ...
            val title: String, // 鹿角男孩
            @SerializedName("type")
            val type: String, // show
            @SerializedName("updatedAt")
            val updatedAt: Long, // 1683056998
            ...
            data class Guid(
                @SerializedName("id")
                val id: String, // imdb://tt12809988
            )

            @Keep
            data class Location(
                @SerializedName("path")
                val path: String, // /share/CACHEDEV1_DATA/家庭影院/Video/电视剧/鹿角男孩 (2021-)
            )
            ...
            data class Preferences(
                ...
                data class Setting(
                    ...
                    @SerializedName("default")
                    val default: String, // -1
                    @SerializedName("enumValues")
                    val enumValues: String, // -1:Library default|0:Oldest first|1:Newest first
                    @SerializedName("group")
                    val group: String,
                    @SerializedName("hidden")
                    val hidden: Boolean, // false
                    @SerializedName("id")
                    val id: String, // episodeSort
                    @SerializedName("label")
                    val label: String, // Episode sorting
                    @SerializedName("summary")
                    val summary: String, // How to sort the episodes for this show.
                    @SerializedName("type")
            ...
            data class Rating(
                ...
                val type: String, // audience
                @SerializedName("value")
                val value: Double, // 7.8
            )

            @Keep
            data class Role(
                @SerializedName("filter")
                val filter: String, // actor=7461
                @SerializedName("id")
                val id: Int, // 7461
                @SerializedName("role")
                val role: String, // Tommy Jepperd
                @SerializedName("tag")
                val tag: String, // Nonso Anozie
                @SerializedName("tagKey")
                val tagKey: String, // 5d77682e8a7581001f12cc38
                @SerializedName("thumb")
                val thumb: String, // https://metadata-static.plex.tv/b/people/b2bc68e1a96d15704d5c8b58508a41b4.jpg
            )
        }
    }
}